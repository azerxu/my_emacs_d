...
(defcustom lsp-pylsp-plugins-pyls-isort-enabled nil
  "Enable or disable the pyls_isort plugin."
  :type 'boolean
  :group 'lsp-pylsp)
...
(lsp-register-custom-settings
 '(("pylsp.rope.ropeFolder" lsp-pylsp-rope-rope-folder)
   ...
   ("pylsp.plugins.pyls_isort.enabled" lsp-pylsp-plugins-pyls-isort-enabled t)
   ;; -------------------  custom setting -----------------------
